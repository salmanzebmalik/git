...
To understand the difference between fast forward and three way merge in detail, go to [fast_forward_vs_three_way_merge](/notes/fast_forward_vs_three_way.md).
